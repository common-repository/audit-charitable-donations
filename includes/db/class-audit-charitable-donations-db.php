<?php
/**
 * Audit Charitable Donations DB class.
 *
 * @package   Audit Charitable Donations/Classes/Audit_Charitable_Donations_DB
 * @author    Himani Lotia
...
if ( ! class_exists( 'Audit_Charitable_Donations_DB' ) ) :
	/**
	* Audit_Charitable_Donations_DB
	* @since 1.0.0
	*/
	class Audit_Charitable_Donations_DB extends Charitable_DB {
		/**
		...
		*/
		...
		/**
		* Get sum of expenses group by campaign id
		*/
		public function get_expenses_total() {
			global $wpdb;
			return $wpdb->get_results("SELECT expense_campaign_id campaign_id, SUM(expense_amount) Total FROM {$this->table_name} GROUP BY expense_campaign_id;");
		}
	}
endif;